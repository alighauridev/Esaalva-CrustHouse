  ...
  render() {
    let addedItems = this.props.items.length ?
      (
        this.props.items.map(item => {
          return (
            <div className="bg-white border w-full pl-3 pr-4 rounded-lg my-2" key={item.id}>
              <div className="relative text-gray-500  pb-6 mt-6">
    ...
    return (
      <div className="container max-w-5xl mx-auto px-4 sm:px-8">
        <section className="cart p-3 bg-white shadow-lg rounded-sm mt-2 border-">

          <div className="flex"> <h1 className='font-bold text-xl text-3xl '>Cart</h1></div>
          {addedItems}
        </section>
